...
def main(n_iter, n_batch, n_hidden, rsc, time_steps, learning_rate, savefile, model, input_type, out_every_t, loss_function):
    ...
    if (model == 'LSTM'):           
        ...
        inputs, parameters, costs = tanhRNNrsc(
            n_input, n_hidden, n_output, rsc=rsc,
...
if __name__=="__main__":
    ...
    parser.add_argument("rsc", type=int, default=3)
    parser.add_argument("time_steps", type=int, default=200)
    parser.add_argument("learning_rate", type=float, default=0.001)
    parser.add_argument("savefile", default='tmp.pkl')
    ...
    print "running rsc=%d, time_steps=%d, model=%s" % (dict['rsc'], dict['time_steps'], dict['model']) 
    main(**kwargs)
